...
$sql = "SELECT inventory_id FROM inventory WHERE name = 'Sloane Cane Chair';";
...
<header>
    ...
    <div class="breadcrumb">
        <a href="home.php">Home</a> > <a href="Chairs.php">Chairs</a> > Sloane Cane Chair
    </div>
    ...
    <section class="product-container">
        <div class="product-details">
            ...
            <h1><?php echo htmlspecialchars($product['name'] ?? 'No Name'); ?></h1>
                <div class="price-rating">
                    <div class="price-container">
                        <span class="original-price">PHP 2,500</span>
                        <span class="price">PHP 1,499</span>             
                    </div>
                    <div class="rating">
                        <span class="stars">★★★★<span class="half-star">★</span></span>
                        <span class="rating-text">5.0 / 5.0 (399)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="description">
                <p>Juxtaposed against a refined cane backrest, the Sloane Dining Chair is upholstered in a vivid, playful print that makes a bold statement.​​​</p>
                <p>With its natural cane details, premium upholstery, and warm honey oak finish, this elegant seating option effortlessly blends classic and contemporary styles for a refined look in any home.</p>
            </div>
        ...
        <input type="hidden" name="product_name" value="Sloane Cane Chair">
        <input type="hidden" name="product_price" value="1499">
        <input type="hidden" name="product_image" value="chair5.jpg">
        ...
        <div class="main-product-image">
            <img src="chair5.jpg" alt="Austen Counter Stool">
        </div>
    </section>
    ...
    <section class="additional-info">
        ...
        <div class="info-content">
            <p>
            This upholstered seating combines timeless craftsmanship with modern comfort, making it a sophisticated addition to any space. The frame is made of solid ash wood, ensuring durability and a sturdy foundation. The cane backrest adds a touch of natural texture and breathability, enhancing both aesthetics and comfort.            </p>
            
            <p>
            The seat is upholstered with fabric and filled with PU foam and polyester, providing a plush and supportive sitting experience. The honey oak wood finish, applied with a water-based coating, highlights the natural beauty of the wood while ensuring longevity.            </p>

            <p>
            Designed for easy care and maintenance, this seating piece is both functional and stylish.
            </p>
        </div>
        
        <div class="info-image">
            <img src="chair-5.jpg" alt="White Couch with Pillows">
        </div>
    </section>
