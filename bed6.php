...
$sql = "SELECT inventory_id FROM inventory WHERE name = 'Claude Performance Fabric Bed';";
...
<header>
    ...
    <div class="breadcrumb">
        <a href="home.php">Home</a> > <a href="Beds.php">Beds</a> > Claude Performance Fabric Bed
    </div>
    ...
    <section class="product-container">
        <div class="product-details">
            <div class="product-header">
                ...
                <div class="price-rating">
                    <div class="price-container">
                        <span class="price">PHP 12,000</span>             
                    </div>
                    <div class="rating">
                        <span class="stars">★★★★<span class="half-star">★</span></span>
                        <span class="rating-text">3.8 / 5.0 (290)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="description">
                <p>Claude's floating nightstands and adjustable headrests bring space-saving solutions to your bedroom, merging storage and slumber.​​</p>
                <p>Each piece features natural color variations, making every bed uniquely stylish. The headboard backing is lined with black non-woven fabric, ensuring a clean and polished appearance.</p>
            </div>
        ...
        <input type="hidden" name="product_name" value="Claude Performance Fabric Bed">
        <input type="hidden" name="product_price" value="12000">
        <input type="hidden" name="product_image" value="bed6.jpg">
        ...
        <div class="main-product-image">
            <img src="bed6.jpg" alt="Claude Performance Fabric Bed">
        </div>
    </section>
    ...
    <section class="additional-info">
        ...
        <div class="info-content">
            <p>
            Blending modern functionality with timeless design, this upholstered bed frame is crafted for durability and comfort. The frame is constructed from engineered wood and plywood with an oak veneer, offering both strength and a natural wood aesthetic. The middle leg is made of solid pine wood, providing additional stability and support.            </p>
            
            <p>
            Upholstered in 100% polyester spill-resistant performance fabric, this bed is designed for easy maintenance and long-lasting beauty. The headrest strap is made of top-grain wax leather, adding a sophisticated and unique touch. The foam and fiber filling ensures plush comfort, making the bed perfect for relaxation.            </p>

            <p>
            Each piece features natural color variations, making every bed uniquely stylish. The headboard backing is lined with black non-woven fabric, ensuring a clean and polished appearance.            </p>
        </div>
