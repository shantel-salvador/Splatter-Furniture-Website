...
$sql = "SELECT inventory_id FROM inventory WHERE name = 'Dawson Bed';";
...
<header>
    ...
    <div class="breadcrumb">
        <a href="home.php">Home</a> > <a href="Beds.php">Beds</a> > Dawson Bed
    </div>
    ...
    <section class="product-container">
        <div class="product-details">
            <div class="product-header">
                ...
                <div class="price-rating">
                    <div class="price-container">
                        <span class="price">PHP 10,000</span>             
                    </div>
                    <div class="rating">
            ...
            <div class="description">
                ...
                <p>With its elegant look, practical features, and easy upkeep, this upholstered bed is a perfect choice for those who value both aesthetics and functionality.</p>
            </div>
        ...
        <input type="hidden" name="product_name" value="Dawson Bed">
        <input type="hidden" name="product_price" value="10000">
        <input type="hidden" name="product_image" value="bed8.jpg">
        ...
        <div class="main-product-image">
            <img src="bed8.jpg" alt="Austen Counter Stool">
        </div>
    </section>
    ...
    <section class="additional-info">
        ...
        <div class="info-content">
            <p>
            This modern upholstered bed combines style, comfort, and practicality to create a relaxing bedroom centerpiece. Its sturdy plywood frame ensures long-lasting durability, while the plastic side legs and solid wood middle legs provide excellent stability. Designed for superior support, the plywood bed slats evenly distribute weight, enhancing mattress longevity.            </p>
            
            <p>
            Upholstered in a soft yet durable blend of 93% polyester and 7% linen, this bed offers a refined texture that complements various interior styles. The foam and fiber-filled headboard provides plush comfort, making it perfect for reading or lounging. The non-woven fabric backing adds a clean, seamless finish to the design.            </p>

            <p>
            For added convenience, the bed features fully removable covers that are machine washable, making maintenance effortless. While the fabric may have slight natural variations in texture and color, this only enhances its unique charm.            </p>
        </div>
        
        <div class="info-image">
            <img src="bed-6.jpg" alt="White Couch with Pillows">
        </div>
    </section>
