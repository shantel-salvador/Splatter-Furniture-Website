...
$sql = "SELECT inventory_id FROM inventory WHERE name = 'Kelsey Counter Stool';";
...
<header>
    ...
    <div class="breadcrumb">
        <a href="home.php">Home</a> > <a href="Chairs.php">Chairs</a> > Kelsey Stool
    </div>
    ...
    <section class="product-container">
        <div class="product-details">
            <div class="product-header">
                ...
                <div class="price-rating">
                    <div class="price-container">
                        <span class="original-price">PHP 5,999</span>
                        <span class="price">PHP 4,700</span>
                    </div>
                    <div class="rating">
            ...
            <div class="description">
                <p>Enhance your kitchen or bar area with the stylish and functional Kelsey Counter Stool. Designed with a modern aesthetic in mind, this stool features a comfortable upholstered seat and a bar-height frame that provides the perfect perch for enjoying conversation and refreshments. </p>
                <p>Crafted with durable metal, the Kelsey Counter Stool offers a sturdy and long-lasting foundation. The integrated footrest ensures added comfort during extended seating.</p>
            </div>
        ...
        <input type="hidden" name="product_name" value="Kelsey Stool">
        <input type="hidden" name="product_price" value="4700">
        <input type="hidden" name="product_image" value="chair3.jpg">
        ...
        <div class="main-product-image">
            <img src="chair3.jpg" alt="Austen Counter Stool">
        </div>
    </section>
    ...
    <section class="additional-info">
        ...
        <div class="info-content">
            <p>
            Whether you're hosting a cocktail party or simply enjoying a casual breakfast, the Kelsey Counter Stool adds a touch of sophistication to your space.            </p>
            
        </div>
        
        <div class="info-image">
            <img src="product-three.jpg" alt="White Couch with Pillows">
        </div>
    </section>
