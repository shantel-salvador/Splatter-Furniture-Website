...
<header>
    ...
    <div class="breadcrumb">
        <a href="home.php">Home</a> > <a href="Beds.php">Beds</a> > Rochelle Performance Bouclé Bed
    </div>
    ...
    <section class="product-container">
        <div class="product-details">
            <div class="product-header">
                ...
                <div class="price-rating">
                    <div class="price-container">
                        <span class="price">PHP 23,000</span>             
                    </div>
                    <div class="rating">
            ...
            <div class="description">
                <p>Upholstered in performance bouclé fabric, Rochelle's soft curves and wooden poster legs make a quiet statement in the bedroom.​​</p>
                <p>The plush headboard is filled with PU foam and fiber, offering superior comfort for lounging or reading in bed. The plywood bed slats provide strong and even support, helping to extend the life of your mattress.</p>
            </div>
        ...
        <input type="hidden" name="product_name" value="Rochelle Performance Bouclé Bed">
        <input type="hidden" name="product_price" value="23000">
        <input type="hidden" name="product_image" value="bed4.jpg">
        ...
        <div class="main-product-image">
            <img src="bed4.jpg" alt="Austen Counter Stool">
        </div>
    </section>
    ...
    <section class="additional-info">
        ...
        <div class="info-content">
            <p>
            Experience both comfort and durability with this upholstered bed frame, crafted with a sturdy engineered wood and plywood frame for long-lasting support. The leg frame features a combination of solid pine wood for the middle leg and solid ash for the side legs, ensuring stability and strength. The side legs are finished in a white wash, adding a subtle, elegant touch to the design.
            </p>
            
            <p>
            Designed for easy maintenance, this upholstered bed blends functionality with style. The headboard backing is lined with black non-woven fabric, ensuring a clean and polished appearance.
            </p>
        ...
        <div class="info-image">
            <img src="bed-4.jpg" alt="White Couch with Pillows">
        </div>
    </section>
