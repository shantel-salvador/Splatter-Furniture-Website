...
$sql = "SELECT inventory_id FROM inventory WHERE name = 'Crescent Bed';";
...
<header>
    ...
    <div class="breadcrumb">
        <a href="home.php">Home</a> > <a href="Beds.php">Beds</a> > Crescent Bed
    </div>
    ...
    <section class="product-container">
        <div class="product-details">
            <div class="product-header">
                ...
                <div class="price-rating">
                    <div class="price-container">
                        <span class="original-price">PHP 25,000</span>
                        <span class="price">PHP 18,000</span>             
                    </div>
                    <div class="rating">
            ...
            <div class="description">
                <p>The Crescent Bed is crafted with mindi wood and exudes an airy, earthy appeal. Its softly curved edges lend a modern touch to your space.</p>
                <p>Bring a touch of natural elegance to your bedroom with this beautifully crafted wooden bed frame, made from laminated solid mindi wood for exceptional durability and support. The leg frame and main frame are constructed from solid mindi wood, reinforced with two center supports for added stability.</p>
            </div>
        ...
        <input type="hidden" name="product_name" value="Crescent Bed">
        <input type="hidden" name="product_price" value="15999">
        <input type="hidden" name="product_image" value="bed2.jpg">
        ...
        <div class="main-product-image">
            <img src="bed2.jpg" alt="Austen Counter Stool">
        </div>
    </section>
    ...
    <section class="additional-info">
        ...
        <div class="info-content">
            <p>
            Finished in a light white wash lacquer with a wirebrushed texture, this bed showcases the wood’s natural grain, giving it a rustic yet refined look. The finger joint laminated mahogany bed slats provide strong, even support, helping to extend the life of your mattress.
            </p>
            
            <p>
            Designed for easy maintenance, this wooden bed retains its charm with minimal care. Due to the natural variations in color, each piece is unique, adding to its organic beauty. The headboard backing is made of particle board with a 1.2mm veneer mindi front and an albasia veneer back, ensuring structural integrity while maintaining a polished appearance.
            </p>
        ...
        <div class="info-image">
            <img src="bed-2.jpg" alt="White Couch with Pillows">
        </div>
    </section>
